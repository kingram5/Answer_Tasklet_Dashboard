      ...
      <div className="md:hidden space-y-2">
        {sorted.map(acc => (
          <div
            ...
            className="bg-dark-800 border border-white/10 rounded-lg p-3 cursor-pointer hover:border-white/20 transition-colors"
          >
                        ...
                        <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm">
                          ...
                          <div onClick={(e) => e.stopPropagation()}>
                            ...
                            <select
                              ...
                              className="bg-dark-700 border border-white/10 rounded px-2 py-1 text-sm text-gray-300 focus:outline-none mt-1"
                            >
